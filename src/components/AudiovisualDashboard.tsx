...
import AudiovisualHome from './audiovisual/AudiovisualHome';
...
interface AudiovisualDashboardProps {
  userName: string;
  onLogout: () => void;
}

type MenuOption = 'home' | 'horarios' | 'visualizacion' | 'prestamos' | 'ocupacion' | 'reportes' | 'notificaciones' | 'mensajeria' | 'ajustes';
  ...
  const menuSections: Array<{ id: string; label: string; items: MenuItem[] }> = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'prestamos', icon: Calendar, label: 'Préstamo de Espacios', action: 'prestamos' }
      ]
    },
    {
      id: 'reportes',
              ...
              <AnimatePresence>
                {!isSidebarCollapsed && (
                  ...
                  >
                    ...
                    <p className="text-red-300 whitespace-nowrap">Autorizado</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
                            ...
                            const buttonContent = (
                              ...
                              >
                                ...
                                {item.badge && !isSidebarCollapsed && (
                                  <Badge className="bg-red-600 text-white">{item.badge}</Badge>
                                )}
                              </motion.button>
                            );
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="hidden md:flex flex-1 max-w-xl">
                <div className="relative w-full">
                  ...
                  <Input
                    placeholder="Buscar horarios, espacios, préstamos..."
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <div className="text-right hidden md:block">
                    ...
                    <p className="text-slate-500 dark:text-slate-400">Autorizado</p>
                  </div>
