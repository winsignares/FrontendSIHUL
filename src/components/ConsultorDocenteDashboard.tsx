...
import ConsultorDocenteHome from './consultor/ConsultorDocenteHome.tsx';
import HorarioDocente from './consultor/HorarioDocente.tsx';
import DocentePrestamos from './consultor/DocentePrestamos.tsx';
...
interface ConsultorDocenteDashboardProps {
  userName: string;
  onLogout: () => void;
}
...
export default function ConsultorDocenteDashboard({ userName, onLogout }: ConsultorDocenteDashboardProps) {
  ...
  const menuSections = [
    ...
    },
    {
      ...
      label: 'Mi Actividad',
      items: [
        { id: 'horario', icon: Clock, label: 'Gestionar Horario', action: 'horario' },
        { id: 'prestamos', icon: GraduationCap, label: 'Pedir Préstamos', action: 'prestamos' }
      ]
    }
  ];
  ...
  const getMenuTitle = () => {
    ...
    if (activeMenu === 'prestamos') return 'Préstamos de Espacios';
    return 'Dashboard';
  };
              ...
              <AnimatePresence>
                {!isSidebarCollapsed && (
                  ...
                  >
                    ...
                    <p className="text-red-300 whitespace-nowrap">Docente</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
                            ...
                            const buttonContent = (
                              ...
                              >
                                ...
                                {isActive && !isSidebarCollapsed && (
                                  <motion.div
                                    layoutId="activeIndicatorDocente"
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400">Portal del Docente</p>
                </div>
              </div>
              ...
              <div className="hidden md:flex flex-1 max-w-xl">
                <div className="relative w-full">
                  ...
                  <Input
                    placeholder="Buscar horarios, grupos..."
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <div className="text-right hidden md:block">
                    ...
                    <p className="text-slate-500 dark:text-slate-400">Docente</p>
                  </div>
